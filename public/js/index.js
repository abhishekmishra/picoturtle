...
getJSON('/turtle/create?x=250&y=200', (t) => {
    ...
    getJSON('/turtle/' + t.name + '/forward?d=100', (t) => {
        console.log(t);
    });
    ...
    getJSON('/turtle/' + t.name + '/right?a=90', (t) => {
        console.log(t);
    });
    getJSON('/turtle/' + t.name + '/forward?d=100', (t) => {
        console.log(t);
    ...
    getJSON('/turtle/' + t.name + '/stop', (t) => {
        console.log(t);
    });
});

function track_turtle(t) {
    var local_turtle = new Turtle("turtle_canvas", t);
    // local_turtle.batchStart();
    // local_turtle.exec("forward", 50);
...
async function fetch_commands(local_turtle, cmd_id) {
    getJSON('/turtle/' + local_turtle.name + '/command?id=' + cmd_id, (cmd) => {
        console.log(cmd);
        if ('cmd' in cmd) {
            args = [cmd.cmd];
            if(cmd.args != null) {
...
class Turtle {
    ...
    initTurtle() {
        ...
        this.colour = this.orig_t.colour;
        this.drawTurtle();
    }
