...
run:
ifeq ($(OSFLAG),WIN32)
	$(CMAKE_BUILD_DIR)/Debug/ptrl
else ifeq ($(OSFLAG),OSX)
	$(CMAKE_BUILD_DIR)/ptrl
else
	$(CMAKE_BUILD_DIR)/bin/ptrl
endif

runrelease:
ifeq ($(OSFLAG),WIN32)
	$(CMAKE_BUILD_DIR)/bin/Release/ptrl
else
